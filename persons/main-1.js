...
const company_lenght = () => {
    return arr.reduce((cemi, item) => {
        return cemi + item.company.catchPhrase.length;
    }, 0);
};

console.log(company_lenght());
